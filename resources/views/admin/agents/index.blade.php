    ...
    <div class="row">
        ...
        <div class="col-4">
            <section class="card">
                ...
                {!! Form::open(['method' => 'POST','action'=>'AgentController@store']) !!}
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('agents.index') }}" class="btn btn-success btn-sm"><i class="fa fa-retweet"></i> Reset Search</a>
                </div>
                {!! Form::close() !!}
            </section>
        </div>
                    ...
                    <section class="card">
                        <div class="card-body">
                            <form class="row gx-3 gy-2 align-items-center" method="GET" action="">
                                @csrf
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="searchName" placeholder="Search Agent Code">
                                </div>
                                <div class="col-auto">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title style1" id="exampleLargeModalLabel">Update Agent Entry {{ $d->name }}</h5>
            </div>
