        ...
        <div class="col-4">
            <section class="card">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::select('usertype_id',$usertypes,null,['class'=>'form-control select2 form-control-sm','placeholder'=>'-- Select One --','style'=>'width:100%;']) !!}
                            </div>
                            <div class="form-group">
                                {!! Form::label('Username') !!}
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('users.index') }}" class="btn btn-success btn-sm"><i class="fa fa-retweet"></i> Reset Search</a>
                </div>
                {!! Form::close() !!}
            </section>
        </div>
                    ...
                    <section class="card">
                        <div class="card-body">
                            <form class="row gx-3 gy-2 align-items-center" method="GET" action="">
                                @csrf
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="searchName" placeholder="Search User Name">
                                </div>
                                <div class="col-auto">
                    ...
                    <table class="table table-sm table-condensed table-no-more" style="text-transform:uppercase;font-size:12px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-title="Name" class="text-center">{{ $d->usertype->name }}</td>
...
<div id="edit{{ $d->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {!! Form::open(['method'=>'PATCH','action'=>['UserController@update',$d->id]]) !!}
            <div class="modal-header">
                <h5 class="modal-title style1" id="exampleLargeModalLabel">Update User Entry {{ $d->name }}</h5>
            </div>
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="form-group">
                                {!! Form::label('Select Usertype') !!}
                                {!! Form::select('usertype_id',$usertypes,$d->usertype_id,['class'=>'form-control form-control-sm','placeholder'=>'-- Select One --','style'=>'width:100%;']) !!}
                            </div>
                        <div class="form-group">
                            {!! Form::label('Name') !!}
