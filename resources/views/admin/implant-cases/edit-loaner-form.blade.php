...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-12 mb-2">
            @include('alert')
            <a href="{{ route('implant-cases.loaner-form',$lf->subcase_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-home"></i> Back to Main</a>
        </div>
        <div class="col-12">
            <section class="card">
                ...
                {!! Form::model($lf,['method'=>'PATCH','action'=>['ImplantCaseController@loanerform_update',$lf->id]]) !!}
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                {!! Form::label('','Loaner Form Name') !!}
        ...
        $.ajax({    //create an ajax request to load_page.php
            ...
            success: function(response){
                ...
                $.each(response,function(index,value){
                    ...
                    data += '<td>{!! Form::text("qty[]",0,["class"=>"form-control form-control-sm","style"=>"width:50px;text-align:center;"]) !!}</td>';
                    data += '</tr>';
