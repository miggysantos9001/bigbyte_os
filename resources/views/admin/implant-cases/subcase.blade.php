...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-12 mb-2">
            @include('alert')
            <a href="{{ route('implant-cases.index') }}" class="btn btn-primary btn-sm"><i class="fa fa-home"></i> Back to Main</a>
        </div>
        <div class="col-4">
            <section class="card">
                <header class="card-header">
                    ...
                    <h4 class="card-title">Create Implant Sub Case</h4>
                </header>
                {!! Form::open(['method' => 'POST','action'=>['ImplantCaseController@subcase_store',$implant->id]]) !!}
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! Form::label('Implant Sub Case Name') !!}
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ action('ImplantCaseController@subcase_index',$implant->id) }}" class="btn btn-success btn-sm"><i class="fa fa-retweet"></i> Reset Search</a>
                </div>
                {!! Form::close() !!}
            </section>
        </div>
        <div class="col-8">
            <section class="card">
                <header class="card-header">
                    ...
                    <h4 class="card-title">Impant Sub Case List for {{ $implant->name }}</h4>
                </header>
                <div class="card-body">
                    <section class="card">
                        <div class="card-body">
                                ...
                                <td data-title="Action" class="text-center">
                                    <div class="btn-group flex-wrap">
                                        ...
                                        <div class="dropdown-menu" role="menu" style="">
                                            ...
                                            <a class="dropdown-item text-1" href="{{ route('implant-cases.loaner-form',$d->id) }}">View Loaner Form</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<div id="edit{{ $d->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {!! Form::open(['method'=>'PATCH','action'=>['ImplantCaseController@subcase_update',$d->id]]) !!}
            <div class="modal-header">
                <h5 class="modal-title style1" id="exampleLargeModalLabel">Update Implant Subcase Entry {{ $d->name }}</h5>
            </div>
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label('Implant Subcase Name') !!}
