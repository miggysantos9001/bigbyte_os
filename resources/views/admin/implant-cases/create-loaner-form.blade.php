...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-12 mb-2">
            @include('alert')
            <a href="{{ route('implant-cases.loaner-form',$subcase->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-home"></i> Back to Main</a>
        </div>
        <div class="col-12">
            <section class="card">
                ...
                {!! Form::open(['method'=>'POST','action'=>['ImplantCaseController@loanerform_store',$subcase->id]]) !!}
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
