    ...
    <div class="row">
        ...
        <div class="col-4">
            <section class="card">
                ...
                {!! Form::open(['method' => 'POST','action'=>'CaseStatusController@store']) !!}
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('case-statuses.index') }}" class="btn btn-success btn-sm"><i class="fa fa-retweet"></i> Reset Search</a>
                </div>
                {!! Form::close() !!}
            </section>
        </div>
        <div class="col-8">
            <section class="card">
                <header class="card-header">
                    ...
                    <h4 class="card-title">Case Status List</h4>
                </header>
                <div class="card-body">
                    <section class="card">
                        <div class="card-body">
                            <form class="row gx-3 gy-2 align-items-center" method="GET" action="">
                                @csrf
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="searchName" placeholder="Search Status Entry">
                                </div>
                                <div class="col-auto">
...
<div id="edit{{ $d->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {!! Form::open(['method'=>'PATCH','action'=>['CaseStatusController@update',$d->id]]) !!}
            <div class="modal-header">
                <h5 class="modal-title style1" id="exampleLargeModalLabel">Update Case Status Entry {{ $d->name }}</h5>
            </div>
