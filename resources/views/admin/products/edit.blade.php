        ...
        <div class="col-12">
            <section class="card">
                <header class="card-header">
                    ...
                    <small style="color: red;text-transform: uppercase;">*always check Category Level One and Two before saving</small>
                </header>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('category_id',$categories,$product->subtwo->subone->category_id,['class'=>'select2 form-control form-control-sm','placeholder'=>'-- Select One --','id'=>'combo1']) !!}
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('uom_id',['PC'=>'PC'],null,['class'=>'select2 form-control form-select-sm']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('capital_usd',null,['class'=>'form-control form-control-sm cap_usd']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('','Exchange Rate') !!}
                                {!! Form::text('exchange_rate',null,['class'=>'form-control form-control-sm rate']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('','Capital PHP') !!}
                                {!! Form::text('capital_php',null,['class'=>'form-control form-control-sm cap_php']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('agent_price',null,['class'=>'form-control form-control-sm']) !!}
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                {!! Form::label('','Outsource Price') !!}
                                {!! Form::text('outsource_price',null,['class'=>'form-control form-control-sm']) !!}
                            </div>
                        </div>
                    </div>
                </div>
