...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Product Categories Module</h2>
    </header> 
    <div class="row">
        <div class="col-4">
    </div>
        ...
        <div class="col-4">
            <section class="card">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('product-categories.index') }}" class="btn btn-success btn-sm"><i class="fa fa-retweet"></i> Reset Search</a>
                </div>
                {!! Form::close() !!}
            </section>
        </div>
                    ...
                    <section class="card">
                        <div class="card-body">
                            <form class="row gx-3 gy-2 align-items-center" method="GET" action="">
                                @csrf
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="searchName" placeholder="Search Category Name">
                                </div>
                                <div class="col-auto">
...
<div id="edit{{ $d->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {!! Form::open(['method'=>'PATCH','action'=>['ProductCategoryController@update',$d->id]]) !!}
            <div class="modal-header">
                <h5 class="modal-title style1" id="exampleLargeModalLabel">Update Category Entry {{ $d->name }}</h5>
            </div>
