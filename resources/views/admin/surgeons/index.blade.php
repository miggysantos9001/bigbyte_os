        ...
        <div class="col-4">
            <section class="card">
                <header class="card-header">
                    ...
                    <h4 class="card-title">Create Surgeon</h4>
                </header>
                {!! Form::open(['method' => 'POST','action'=>'SurgeonController@store']) !!}
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! Form::label('Select Branch') !!}
                                {!! Form::select('branch_id',$branches,null,['class'=>'form-control select2 form-control-sm','placeholder'=>'-- Select One --','style'=>'width:100%;']) !!}
                            </div>
                            <div class="form-group">
                                {!! Form::label('Surgeon Name') !!}
        ...
        <div class="col-8">
            <section class="card">
                <header class="card-header">
                    ...
                    <h4 class="card-title">Surgeons List</h4>
                </header>
                <div class="card-body">
                    <section class="card">
                        <div class="card-body">
                            <form class="row gx-3 gy-2 align-items-center" method="GET" action="">
                                @csrf
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="searchName" placeholder="Search Surgeon Name">
                                </div>
                                <div class="col-auto">
...
<div id="edit{{ $d->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {!! Form::open(['method'=>'PATCH','action'=>['SurgeonController@update',$d->id]]) !!}
            <div class="modal-header">
                <h5 class="modal-title style1" id="exampleLargeModalLabel">Update Surgeon Entry {{ $d->name }}</h5>
            </div>
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="form-group">
                                {!! Form::label('Select Branch') !!}
                                {!! Form::select('branch_id',$branches,$d->branch_id,['class'=>'form-control form-control-sm','placeholder'=>'-- Select One --','style'=>'width:100%;']) !!}
                            </div>
                        <div class="form-group">
                            {!! Form::label('Surgeon Name') !!}
