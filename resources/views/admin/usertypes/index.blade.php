    ...
    <div class="row">
        ...
        <div class="col-4">
            <section class="card">
                ...
                {!! Form::open(['method' => 'POST','action'=>'UsertypeController@store']) !!}
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('usertypes.index') }}" class="btn btn-success btn-sm"><i class="fa fa-retweet"></i> Reset Search</a>
                </div>
                {!! Form::close() !!}
            </section>
        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title style1" id="exampleLargeModalLabel">Update Usertype Entry {{ $d->name }}</h5>
            </div>
